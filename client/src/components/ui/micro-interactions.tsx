...
// Contact info reveal animation with hover effect
export const ContactReveal = ({
  ...
  React.useEffect(() => {
    // Auto-reveal after a delay if not hover-dependent
    if (!revealOnHover) {
  ...
  return (
    <motion.div 
      ...
      onMouseLeave={handleMouseLeave}
      initial="hidden"
      animate={(isHovered || isRevealed) ? "visible" : "hidden"}
