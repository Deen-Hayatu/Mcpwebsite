      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
          ...
          <div className="space-y-8">
            ...
            <div>
              <h3 className="text-xl font-bold mb-4 border-b pb-2">Connect With Us</h3>
              <p className="text-muted-foreground mb-4">
                Follow us on social media to stay updated with our latest research, 
        ...
        <div className="relative h-96 w-full rounded-lg overflow-hidden shadow-md">
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15882.451508304275!2d-0.1719216!3d5.6349296!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfdf9c7ebaeaaaab%3A0x5e8dc5acf5f0f944!2sEast%20Legon%2C%20Accra!5e0!3m2!1sen!2sgh!4v1682319879760!5m2!1sen!2sgh" 
